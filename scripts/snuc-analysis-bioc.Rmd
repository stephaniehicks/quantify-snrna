...
```{r eval = F}
library(here)
dataset = "preandmrna" # options = "transcripts", "preandmrna"
```
...
if(!file.exists(se_file_name)){
  ...
  if(dataset == "preandmrna")
    ...
    se <- tximeta(coldata, type = "salmon") # run this line if you used mRNA transcripts in your index only, it will automatically detect the right transcriptome
...
library(tidyr)
library(SingleCellExperiment)
dataset = "mrna" # options = "premrna_mrna", "mrna", or "preandmrna"
```
