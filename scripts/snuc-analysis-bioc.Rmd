...
1. Using counts, i.e. cells with (a) a small library size (total sum of counts) or (b) few expressed endogeneous genes (nonzero counts for those genes)
...
# detected contains the number of detected genes
