...
if(dataset == "mrna"){
  ...
  # but note that some mRNA transcripts were dropped in the pseudo-UMI conversion step (including those, 40471 mRNA transcripts did not have an premRNA counterpart)
  # 231 premRNA transcripts did not have a mRNA counterpart
