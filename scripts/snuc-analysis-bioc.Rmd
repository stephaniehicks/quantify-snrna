...
if(file.exists(umi_file_name)){
  ...
  dat_umi = quminorm_matrix(dat_filtered, shape = median(sig_vec)) # Takes a couple of minutes. You should be able to use a vector for the shape parameter too instead of using the median for all cells. # You should use the mode
