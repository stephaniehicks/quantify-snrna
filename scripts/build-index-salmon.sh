...
salmon index -t /fastscratch/myscratch/akuo/alsf-filbin/salmon_files/gentrome_preandmrna.fa.gz \
                -d /fastscratch/myscratch/akuo/alsf-filbin/salmon_files/decoys.txt \
                -i /fastscratch/myscratch/akuo/alsf-filbin/salmon_files/gencode.v32_salmon-index-v1.0.0-preandmrna --gencode --threads 4
