...
salmon index -t /fastscratch/myscratch/akuo/alsf-filbin/salmon_files/gencode.v32.transcripts.fa.gz \
                -d /fastscratch/myscratch/akuo/alsf-filbin/salmon_files/decoys.txt \
                -i /fastscratch/myscratch/akuo/alsf-filbin/salmon_files/gencode.v32_salmon-index-v1.0.0-mrna --gencode --threads 4
