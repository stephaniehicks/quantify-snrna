...
* Mouse cortex	~7000?
* UMIs and reads
* RNA-seq data generated in this project are available from the Gene Expression Omnibus with accession number **GSE132044** (raw data on SRA https://www.ncbi.nlm.nih.gov/bioproject/PRJNA545730 ) and the Single Cell Portal with accession numbers SCP424, SCP425 and SCP426. https://singlecell.broadinstitute.org/single_cell/study/SCP425/single-cell-comparison-cortex-data#study-summary
...
write_csv(sra_meta, path = here("files", "SRA_geo_metadata.csv"))
...
In theory, you can skip prefetch and use fasterq-dump by omitting the file extension .sra, but this does not work for their example SRR390728 for some reason.
