...
do
    ...
    fasterq-dump -O "/fastscratch/myscratch/akuo/alsf-filbin/sample_data/geo/sra/" --split-files --include-technical "/fastscratch/myscratch/akuo/alsf-filbin/sample_data/geo/sra/$file.sra"
