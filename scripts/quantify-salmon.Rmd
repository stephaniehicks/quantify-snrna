...
```{r}
# download GENCODE primary assembly fasta 
...
See the `scripts/run-salmon.sh` file or the `scripts/run-salmon-paralle.sh` file in the terminal. They do the same thing, but the latter will run salmon in parallel and be much faster.
