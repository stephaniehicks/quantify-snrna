...
```{r}
if(!file.exists(here("data", "Homo_sapiens.GRCh38.cdna.all.fa.gz"))){
  tar_gz_file <- "ftp://ftp.ensembl.org/pub/release-98/fasta/homo_sapiens/cdna/Homo_sapiens.GRCh38.cdna.all.fa.gz"
  download.file(tar_gz_file, 
                destfile = here("data", "Homo_sapiens.GRCh38.cdna.all.fa.gz"), 
                method = "wget")
}
