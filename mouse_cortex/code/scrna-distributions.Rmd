...
for(i in seq_along(lambdas)){
  ...
  counts_ls[[i+4+length(lambdas)]][, (347/2):347] = counts_ls[[i+4]][, (347/2):347]*100 # Second half of cells have size factor 100
}
...
counts_ls[[12]] = counts_ls[[11]][, (347/2):347]*100 # Second half of cells have size factor 100
...
for(i in seq_along(lambdas)){
  for(j in seq_along(phis)){
    ...
    counts_ls[[ind+length(lambdas)*length(phis)]][, (347/2):347] = counts_ls[[ind]][, (347/2):347]*100 # Second half of cells have size factor 100
  }
}
...
counts_ls[[38]] = counts_ls[[37]][, (347/2):347]*100 # Second half of cells have size factor 100
