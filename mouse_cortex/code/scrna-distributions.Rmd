...
counts_ls[[i+1]] = matrix(rnbinom(n = 347*21434, size = 1.5, mu = 0.5), ncol = 347, nrow  = 21434) # negative binomial
counts_ls[[i+2]] = matrix(rpois(n = 347*21434, lambda = 0.5), ncol = 347, nrow = 21434) # poisson 
```
