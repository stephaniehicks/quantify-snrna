...
```{r}
pca = readRDS(here("./mouse_cortex/plots_enar/pca_kmeans_preandmnra_inhibitory_neuron_cortex_1.rds"))
a = readRDS(here("./mouse_cortex/plots_enar/prob0_plot_preandmrna_inhibitory_neuron_cortex_1_cluster_1.rds"))
b = readRDS(here("./mouse_cortex/plots_enar/prob0_plot_preandmrna_inhibitory_neuron_cortex_1_cluster_2.rds"))
c = readRDS(here("./mouse_cortex/plots_enar/prob0_plot_preandmrna_inhibitory_neuron_cortex_1_cluster_3.rds"))
d = readRDS(here("./mouse_cortex/plots_enar/prob0_plot_preandmrna_inhibitory_neuron_cortex_1_cluster_4.rds"))
