...
```{r}
a = readRDS(here("./mouse_cortex/plots/gene_length_bias_cortex_1.rds"))
b = readRDS(here("./mouse_cortex/plots/de_length_bias_ea.rds"))

a = a +
  theme(legend.position = "top")

p = plot_grid(a, b, nrow = 1, labels = "auto")
print(p)
ggsave(here("./publication/figures/figure_6.png"), plot = p, width = 12, height = 5)
```
