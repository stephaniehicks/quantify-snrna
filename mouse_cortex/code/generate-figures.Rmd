...
a = readRDS(here("./mouse_cortex/plots/nA8_preandmrna_length_bias.rds"))
b = readRDS(here("./mouse_cortex/plots/nA8_transcript_length_bias.rds"))
...
# Supplementary Figure 6 (gene length bias across pipeline and distribution of lengths within each bin)
