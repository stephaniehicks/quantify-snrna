...
```{r}
a = readRDS(here("./mouse_cortex/plots/preandmrna_gene_length_bin.rds"))
b = readRDS(here("./mouse_cortex/plots/transcript_gene_length_bin.rds"))
c = readRDS(here("./mouse_cortex/plots/preandmrna_length_bias_pipelines.rds"))
d = readRDS(here("./mouse_cortex/plots/transcripts_length_bias_pipelines.rds"))

p = plot_grid(a, b, c, d,
              labels = "auto",
              nrow = 2)
print(p)
ggsave(here(paste0("./publication/figures/sfigure_6.png")), plot = p, width = 12, height = 8)
```
