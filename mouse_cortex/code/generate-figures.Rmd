...
apply_fig1_aesthetics = function(p, type){
  # Line thickness
  q = ggplot_build(p)  # get plot data
  q$data[[2]]$size = 1 # change thickness
  p = ggplot_gtable(q) # gtable object
  p = as.ggplot(p)     # convert back to ggplot
...
a = apply_fig1_aesthetics(a) + labs(title = "Excitatory neuron")
b = apply_fig1_aesthetics(b) + labs(title = "Excitatory neuron", y = "Fraction of zero droplets")
c = apply_fig1_aesthetics(c) + labs(title = "Inhibitory neuron")
d = apply_fig1_aesthetics(d) + labs(title = "Inhibitory neuron", y = "Fraction of zero droplets")
e = apply_fig1_aesthetics(e) + labs(title = "Astrocyte")
f = apply_fig1_aesthetics(f) + labs(title = "Astrocyte", y = "Fraction of zero droplets")
...
for(pipeline in c("transcripts", "introncollapse", "intronseparate")){
  a = readRDS(here(paste0("./mouse_cortex/plots/meanvar_plot_", pipeline, "excitatory_neuron_cortex_1.rds")))
