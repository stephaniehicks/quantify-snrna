...
gtf_path = here("mouse_cortex", "salmon_files", "gencode.vM25.preandmrna.annotation.gtf.gz") 
json_file = here("mouse_cortex", "salmon_files", paste0(basename(index_dir), ".json"))
makeLinkedTxome(indexDir=index_dir,
                source="other", organism="mouse",
                release="other", genome="GRCm38",
...
json_file = here("mouse_cortex", "salmon_files", "gencode.v32_salmon-index-v1.0.0-transcripts-mouse")
...
pipeline = "transcripts" # "transcripts" or "preandmrna"
...
se = readRDS(here("mouse_cortex", "salmon_quants", "se_SRR9169228_transcripts.rds"))
se
```
...
colData(sce)$size = colSums(counts(sce))
plotReducedDim(sce, "PCA", colour_by = "size")
```
