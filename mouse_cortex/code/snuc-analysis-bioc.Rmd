...
lib_sizes_tb = lib_sizes %>%
  ...
  dplyr::rename(preandmrna = lib_size.y,
                ...
                introncollapse = lib_size.x.x,
                intronseparate = lib_size.y.y) %>%
  pivot_longer(cols = c("preandmrna", "transcripts", "introncollapse", "intronseparate"), names_to = "pipeline")
