...
Discard low-quality cells and convert from SummarizedExperiment to SingleCellExperiment.
...
# Plot
gene_sum_tb %>%
  ggplot(aes(x = pipeline, y = protein_coding)) + 
  geom_boxplot() +
  labs(x = "pipeline",
       y = "num_reads") +
  theme_bw()
...
plotReducedDim(sce_ls[["transcripts"]], "PCA", colour_by = "cortex")
```
