...
```{r}
pipeline = "preandmrna"
res = readRDS(here(paste0("./mouse_cortex/output/de_ea_", pipeline, "_lfc.rds")))
...
cqn_res = cqn(counts = counts_sub, lengths = (genes_length_tb$length[nonzero_sums]),
              ...
              subindex = which(rowMeans(counts_sub) > 20), # Default is rowMeans > 50
