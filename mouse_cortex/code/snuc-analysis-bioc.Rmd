...
sce_sub = sce_ls[["transcripts"]][, colData(sce_ls[["transcripts"]])$ding_labels %in% c("Excitatory neuron", "Inhibitory neuron")]
...
# Subset to cluster
i = 1
counts_sub_cluster = counts(sce_sub)[, colData(sce_sub)$labels_kmeans == i]
