...
res_1 = readRDS(here(paste0("./mouse_cortex/output/de_ea_", "transcripts", "_lengthsforcepreandmrna_FALSE", "_lfc.rds")))
res_2 = readRDS(here(paste0("./mouse_cortex/output/de_ea_", "preandmrna", "_lengthsforcepreandmrna_FALSE", "_lfc.rds")))
res_3 = readRDS(here(paste0("./mouse_cortex/output/de_ea_", "transcripts", "_lengthsforcepreandmrna_TRUE", "_lfc.rds")))
...
res_prop_3 = get_prop(res_3, label_normalization = "transcripts-full-length")
res_prop = bind_rows(res_prop_1, res_prop_2, res_prop_3)
