...
sim = tibble(gene_id = 1:n,
             ...
             neuron_expression = rbinom(n = n, size = 1, prob = neuron_prob)*length,
             endothelial_prob = dnorm(length, mean = 8, sd = 5),
             endothelial_expression = rbinom(n = n, size = 1, prob = endothelial_prob)*length)
```
...
# Overall length bias 
sim %>%
  ggplot(aes(x = length, y = expression)) + 
  geom_point(alpha = 0.01) + 
  theme_bw()
